...
# Research Question 2: When renting an Air BnB, what variables will affect the price of the unit you choose?
### EDA
...
* The summary statistics give show us that variables such as WalkScore, TransitScore, and BikeScore all vary from neighborhood to neighborhood. When testing these variables in the model, we will be ale to see how they affect the price of the units. 
