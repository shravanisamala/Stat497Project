...
* The summary statistics give show us how the means of WalkScore and accommodates,and the counts for HighBlack and HighRev all vary from neighborhood to neighborhood. When testing these variables in the model, we will be able to see how they affect the mean price in each neighborhood. 
...
* $\hat{\alpha}_{0}$ = 3.1165; The mean price of an Air Bnb when there a low percentage of black population, WalkScore is 0, a low number of reviews and accommodates zero people is 3.1165.
* $\hat{\alpha}_{1}$ = 21.3451; The mean price of an Air Bnb is 29.603.
* $\hat{\alpha}_{2}$ = 0.3025; The mean price of an Air Bnb is 29.603.
* $\hat{\beta}_{0}$ = 70.4237; The mean decrease in price for units with high reviews is -8.600.
* $\hat{\beta}_{1}$ = -1.4321; The mean decrease in price for units with high reviews is -8.600. 
* $\hat{\beta}_{2}$ = -0.9429; The mean decrease in price for units with high reviews is -8.600. 
* $\hat{\gamma}_{0}$ = -21.3982; The mean decrease in price for units with high reviews is -8.600. 
* $\hat{\gamma}_1$ = -9.2030; The mean increase in price for every one-unit increase in accommodation is 19.138. 
* $\hat{\gamma}_2$ = 0.5224; The mean increase in price for every one-unit increase in accommodation is 19.138.
* $\hat{\sigma}_{u}$= 17.11;  The variance in between-neighborhood deviations in price for units having a high number of reviews is 41.06.
* $\hat{\sigma}_{v}$= 83.27;  The variance in between-person deviations in price for every increase in accommodations if is 114.54.
